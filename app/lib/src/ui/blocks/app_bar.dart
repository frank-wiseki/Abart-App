            ...
            switch (widget.appBarStyle.appBarType) {
              case 'STYLE1':
                return SliverAppBar(
                  ...
                  stretch: false,
                  titleSpacing: 0,
                  leading: widget.appBarStyle.drawer ? IconButton(
                    icon: DunesIcon(iconString: model.blocks.settings.menuIcon),
                    onPressed: () {
                      Scaffold.of(context).openDrawer();
                    },
                  ) : widget.appBarStyle.logo ? Padding(
              ...
              case 'STYLE5':
                return SliverAppBar(
                  ...
                  ) : widget.appBarStyle.barcode ? Icon(CupertinoIcons.barcode_viewfinder) : null,
                  title: Padding(
              ...
              case 'STYLE8':
                return SliverAppBar(
                  ...
                  ) : widget.appBarStyle.barcode ? IconButton(
