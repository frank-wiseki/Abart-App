...
class _ProductsWidgetState extends State<ProductsWidget>
  ...
  void initState() {
    ...
    border = OutlineInputBorder(
        borderRadius: BorderRadius.all(Radius.circular(widget.model.blocks.settings.appBarStyle.borderRadius)),
  ...
  Container buildSearchField(BuildContext context) {
    ...
    double borderRadius = widget.model.blocks.settings.appBarStyle.borderRadius;
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
            return Search(filter: widget.productsBloc.productsFilter, hintText: selectedCategory != null ? widget.model.blocks.localeText.searchIn + ' ' + parseHtmlString(selectedCategory!.name) : widget.model.blocks.localeText.search);
          }));
        },
        child: TextField(
          showCursor: false,
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: DunesIcon(iconString: widget.model.blocks.settings.searchIcon, color: Theme.of(context).brightness == Brightness.dark ? Colors.grey[700] : CupertinoColors.placeholderText),
          ),
        ),
      ),
    );
