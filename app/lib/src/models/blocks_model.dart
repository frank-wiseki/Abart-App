...
class Settings {
  ...
  factory Settings.fromJson(Map<String, dynamic> json) => Settings(
    ...
    menuIcon: json["menuIcon"] == null ? 'FlutterRemix.menu_2_line' : json["menuIcon"],
    ...
    zoomDrawer: json["zoomDrawer"] == true ? true : false,
  );
}
...
class AppBarStyle {
  ...
  factory AppBarStyle.fromJson(Map<String, dynamic> json) => AppBarStyle(
    ...
    borderRadius: _nullOrEmptyOrFalse(json["borderRadius"]) ? 25.0 : double.parse(json["borderRadius"].toString()),
  );
}
...
class Nonce {
  Nonce({
    ...
    required this.unfilteredHtmlComment
  });
  ...
  factory Nonce.fromJson(Map<String, dynamic> json) => Nonce(
    ...
    unfilteredHtmlComment: json["unfiltered_html_comment"] == null ? '' : json["unfiltered_html_comment"],
  );
}
...
enum BlockType { bannerList, bannerGrid, bannerScroll, bannerSlider, categoryList, categoryGrid, categoryScroll, categorySlider, storeList, storeScroll, storeListTile, storeSlider,
  ...
  postList, postScroll, postListTile, postSlider, bannerPresets, textList, htmlList, videoList, videoListWithController, youTubeVideo, iconsGrid, iconsScroll, listTile, buttonList, buttonGrid, animatedText,}
...
final blockTypeValues = EnumValues({
  ...
  "animatedTextList": BlockType.animatedText
});
