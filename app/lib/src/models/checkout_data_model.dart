...
class FieldData {
  FieldData({
    ...
    required this.ppcSaveCheckoutForm,
    required this.ppcCreateOrder,
  });
  ...
  bool userLogged;
  String ppcSaveCheckoutForm;
  String ppcCreateOrder;
  ...
  factory FieldData.fromJson(Map<String, dynamic> json) => FieldData(
    ...
    ppcSaveCheckoutForm: json["ppc_save_checkout_form"] == null ? '' : json["ppc_save_checkout_form"],
    ppcCreateOrder: json["ppc_create_order"] == null ? '' : json["ppc_create_order"],
    //ppc_create_order
  );
}
